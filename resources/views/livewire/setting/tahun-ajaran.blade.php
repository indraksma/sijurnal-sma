...
@section('subtitle', 'Konfigurasi Tahun Ajaran')
@section('icon', 'far fa-calendar')
<div>
            ...
            <div class="col-md-6">
                <div class="card card-angles mb-4 mb-md-0">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Add / Edit Tahun Ajaran</h5>
                    </div>
                    <div class="card-body rounded-bottom">
                        <form method="POST" wire:submit.prevent="store()">
                            <div class="mb-3">
                                <label for="tahun_ajaran" class="form-label">Tahun Ajaran</label>
                                <input wire:model.lazy="tahun_ajaran" type="text" class="form-control"
                                    id="tahun_ajaran" placeholder="Tahun Ajaran" required>
                            </div>
